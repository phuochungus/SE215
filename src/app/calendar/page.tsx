...
const CalendarPage: React.FC = () => {
  ...
  const sidebarItems = [
      ...
      { text: "Nhắn tin", href: "/chat", icon: <img src="/images/clock-icon.svg" alt="clock" className="w-5 h-5" /> },
      { text: "Cài đặt", href: "/settings", icon: <img src="/images/setting-icon.svg" alt="setting" className="w-5 h-5" /> },
  ];
  return (
      <div>
