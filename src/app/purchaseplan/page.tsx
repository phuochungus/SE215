    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-[#4E4C67] text-white p-4 h-full overflow-y-auto">
        <nav className="space-y-4">
          <a href="#" className="block py-2 px-4 bg-gray-700 rounded hover:bg-gray-600">Quản lý danh mục mua sắm</a>
          <a href="#" className="block py-2 px-4 hover:bg-gray-600">Kế hoạch mua sắm</a>
          <a href="#" className="block py-2 px-4 hover:bg-gray-600">Lịch sử mua sắm</a>
